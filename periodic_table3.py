...
def Ar_page():    
    ...
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=18 , Group=18 ,Period=3 ,Block= P , CAS Number=7440-37-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'39.948' ,
                       "Oxidation_state = ":'[0]' ,
                       "Atomic_radius (pm)= ":'71',
                       "Covelent_radius(pm) = ":'106' ,
                       "Van der waals radius (pm)=":'188',
                       "Boiling_point(Celcius) = " :'-185.8',
                       "Melting_point(Celcius) =":'-189.3',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'1520.6',
                       "Refractive_index = ": '1.000281',
                       "Speed_of_sound( m/s) = ": '319',
                       "Latent heat of Fusion (KJ/mol)=":'1.18',
                       "Latent heat of Vapourization (kJ/mol)=":'6.5',
                       "Specific heat (J/kgK)=":'520.33',
                       "Thermal conductivity (W/m K)=":'0.01772',
                       "Electronegetivity=":'--',
                       "Neutron cross-section (barn)=":'0.65'
                       }
...
def Rb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Rubidium(Rb)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1861)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=37 , Group=1 ,Period=5 ,Block= S , CAS Number=7440-17-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'85.4678' ,
                       "Oxidation_state = ":'[+1]' ,
                       "Atomic_radius (pm)= ":'265',
                       "Covelent_radius(pm) = ":'220' ,
                       "Boiling_point(Celcius) = " :'688',
                       "Melting_point(Celcius) =":'39.31',
                       "Electron_affinity( kj / mol) = ":'46.9',
                       "First ionization energy (kJ/mol)=":'403',
                       "Speed_of_sound( m/s) = ": '1300',
                       "Latent heat of Fusion (KJ/mol)=":'2.19',
                       "Latent heat of Vapourization (kJ/mol)=":'72',
                       "Specific heat (J/kgK)=":'364',
                       "Thermal conductivity (W/m K)=":'58',
                       "Electronegetivity=":'0.82',
                       "Neutron cross-section (barn)=":'0.38'
                       }
...
def Sr_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Strontium')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1790)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=38 , Group=2 ,Period=5 ,Block= S , CAS Number=7440-24-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'87.62' ,
                       "Oxidation_state = ":'[+2]' ,
                       "Atomic_radius (pm)= ":'219',
                       "Covelent_radius(pm) = ":'195' ,
                       "Boiling_point(Celcius) = " :'1382',
                       "Melting_point(Celcius) =":'777',
                       "Electron_affinity( kj / mol) = ":'5.03',
                       "First ionization energy (kJ/mol)=":'549.5',
                       "Speed_of_sound( m/s) = ": '----',
                       "Latent heat of Fusion (KJ/mol)=":'8',
                       "Latent heat of Vapourization (kJ/mol)=":'137',
                       "Specific heat (J/kgK)=":'300',
                       "Thermal conductivity (W/m K)=":'35',
                       "Electronegetivity=":'0.095',
                       "Neutron cross-section (barn)=":'1.2'
                       }
...
def Y_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Yttrium(Y)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1794)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=39, Group=3 ,Period=5 ,Block= d , CAS Number=7440-65-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'88.90584' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'212',
                       "Covelent_radius(pm) = ":'190' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3345',
                       "Melting_point(Celcius) =":'1526',
                       "Electron_affinity( kj / mol) = ":'29.6',
                       "First ionization energy (kJ/mol)=":'600',
                       "Refractive_index = ": '-----',
                       "Speed_of_sound( m/s) = ": '3300',
                       "Latent heat of Fusion (KJ/mol)=":'11.4',
                       "Latent heat of Vapourization (kJ/mol)=":'380',
                       "Specific heat (J/kgK)=":'298',
                       "Thermal conductivity (W/m K)=":'17',
                       "Electronegetivity=":'1.22',
...
def Zr_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Zirconium(Zr)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year :1789)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no= 40, Group=4 ,Period=5 ,Block= d , CAS Number=7440-67-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'91.224' ,
                       "Oxidation_state = ":'[+3,+4]' ,
                       "Atomic_radius (pm)= ":'206',
                       "Covelent_radius(pm) = ":'175' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'4409',
                       "Melting_point(Celcius) =":'1855',
                       "Electron_affinity( kj / mol) = ":'41.1',
                       "First ionization energy (kJ/mol)=":'640.1',
                       "Refractive_index = ": '-----',
                       "Speed_of_sound( m/s) = ": '3800',
                       "Latent heat of Fusion (KJ/mol)=":'21',
                       "Latent heat of Vapourization (kJ/mol)=":'580',
                       "Specific heat (J/kgK)=":'278',
                       "Thermal conductivity (W/m K)=":'23',
                       "Electronegetivity=":'1.33',
                       "Neutron cross-section (barn)=":'0.184'
                       }
...
def Nb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Niobium(Nb)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1801)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=41, Group=5 ,Period=5 ,Block= d , CAS Number=7440-03-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'92.90637' ,
                       "Oxidation_state = ":'[-1,+3,+5]' ,
                       "Atomic_radius (pm)= ":'198',
                       "Covelent_radius(pm) = ":'164' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'4744',
                       "Melting_point(Celcius) =":'2477',
                       "Electron_affinity( kj / mol) = ":'86.1',
                       "First ionization energy (kJ/mol)=":'652.1',
                       "Refractive_index = ": '-----',
                       "Speed_of_sound( m/s) = ": '3480',
                       "Latent heat of Fusion (KJ/mol)=":'26.8',
                       "Latent heat of Vapourization (kJ/mol)=":'690',
                       "Specific heat (J/kgK)=":'265',
                       "Thermal conductivity (W/m K)=":'54',
                       "Electronegetivity=":'1.6',
...
def Mo_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Molybdenum(Mo)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1781)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=42 , Group=6 ,Period=5 ,Block= d , CAS Number=7439-98-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'95.95' ,
                       "Oxidation_state = ":'[-2,+2,+3,+4,+5,+6]' ,
                       "Atomic_radius (pm)= ":'190',
                       "Covelent_radius(pm) = ":'154' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'4639',
                       "Melting_point(Celcius) =":'2623',
                       "Electron_affinity( kj / mol) = ":'71.9',
                       "First ionization energy (kJ/mol)=":'684.3',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '6190',
                       "Latent heat of Fusion (KJ/mol)=":'36',
                       "Latent heat of Vapourization (kJ/mol)=":'600',
                       "Specific heat (J/kgK)=":'251',
                       "Thermal conductivity (W/m K)=":'139',
                       "Electronegetivity=":'2.16',
                       "Neutron cross-section (barn)=":'2.6'
                       }
...
def Tc_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Technetium(Tc)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1937)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=43 , Group=7 ,Period=5 ,Block= d , CAS Number=7440-26-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'98' ,
                       "Oxidation_state = ":'[-1,+4,+7]' ,
                       "Atomic_radius (pm)= ":'183',
                       "Covelent_radius(pm) = ":'147' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'4265',
                       "Melting_point(Celcius) =":'2157',
                       "Electron_affinity( kj / mol) = ":'53',
                       "First ionization energy (kJ/mol)=":'702',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'23',
                       "Latent heat of Vapourization (kJ/mol)=":'550',
                       "Specific heat (J/kgK)=":'63',
                       "Thermal conductivity (W/m K)=":'51',
                       "Electronegetivity=":'1.9',
                       "Neutron cross-section (barn)=":'22'
                       }
...
def Ru_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Ruthentium(Ru)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1844)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=44 , Group=8 ,Period=5 ,Block= d , CAS Number=7440-18-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'101.07' ,
                       "Oxidation_state = ":'[-2,+2,+3,+4,+6,+8]' ,
                       "Atomic_radius (pm)= ":'178',
                       "Covelent_radius(pm) = ":'146' ,
                       "Boiling_point(Celcius) = " :'4150',
                       "Melting_point(Celcius) =":'2334',
                       "Electron_affinity( kj / mol) = ":'101.3',
                       "First ionization energy (kJ/mol)=":'710.2',
                       "Speed_of_sound( m/s) = ": '5970',
                       "Latent heat of Fusion (KJ/mol)=":'25.7',
                       "Latent heat of Vapourization (kJ/mol)=":'580',
...
def Rh_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Rhodium(Rh)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1803)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=45 , Group=9 ,Period=5 ,Block= d , CAS Number=7440-16-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'102.9055' ,
                       "Oxidation_state = ":'[-1,+2,+3,+4]' ,
                       "Atomic_radius (pm)= ":'173',
                       "Covelent_radius(pm) = ":'142' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'3695',
                       "Melting_point(Celcius) =":'1964',
                       "Electron_affinity( kj / mol) = ":'109.7',
                       "First ionization energy (kJ/mol)=":'719.7',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '4700',
                       "Latent heat of Fusion (KJ/mol)=":'21.7',
                       "Latent heat of Vapourization (kJ/mol)=":'495',
                       "Specific heat (J/kgK)=":'240',
                       "Thermal conductivity (W/m K)=":'150',
                       "Electronegetivity=":'2.28',
                       "Neutron cross-section (barn)=":'145'
                       }
...
def Pd_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Palladium(Pd)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1803)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=46 , Group=10 ,Period=5 ,Block= d , CAS Number=7440-05-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'106.42' ,
                       "Oxidation_state = ":'[+2,+4]' ,
                       "Atomic_radius (pm)= ":'169',
                       "Covelent_radius(pm) = ":'139' ,
                       "Van der waals radius (pm)=":'163',
                       "Boiling_point(Celcius) = " :'2963',
                       "Melting_point(Celcius) =":'1554.9',
                       "Electron_affinity( kj / mol) = ":'53.7',
                       "First ionization energy (kJ/mol)=":'804.4',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '3070',
                       "Latent heat of Fusion (KJ/mol)=":'16.7',
                       "Latent heat of Vapourization (kJ/mol)=":'380',
                       "Specific heat (J/kgK)=":'240',
                       "Thermal conductivity (W/m K)=":'72',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'6.9'
                       }
...
def Ag_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Silver(Ag)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 3000 BC)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=47 , Group=11 ,Period=5 ,Block= d , CAS Number=7440-22-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'107.8682' ,
                       "Oxidation_state = ":'[+1,+2]' ,
                       "Atomic_radius (pm)= ":'165',
                       "Covelent_radius(pm) = ":'145' ,
                       "Van der waals radius (pm)=":'172',
                       "Boiling_point(Celcius) = " :'2162',
                       "Melting_point(Celcius) =":'961.78',
                       "Electron_affinity( kj / mol) = ":'125.6',
                       "First ionization energy (kJ/mol)=":'731',
                       "Refractive_index = ": '-----',
                       "Speed_of_sound( m/s) = ": '2600',
                       "Latent heat of Fusion (KJ/mol)=":'11.3',
                       "Latent heat of Vapourization (kJ/mol)=":'255',
                       "Specific heat (J/kgK)=":'235',
                       "Thermal conductivity (W/m K)=":'430',
                       "Electronegetivity=":'1.93',
                       "Neutron cross-section (barn)=":'63.6'
                       }
...
def Cd_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Cadmium(Cd)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1817)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=48 , Group=12 ,Period=5 ,Block= d , CAS Number=7440-43-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'112.414' ,
                       "Oxidation_state = ":'[+2]' ,
                       "Atomic_radius (pm)= ":'161',
                       "Covelent_radius(pm) = ":'144' ,
                       "Van der waals radius (pm)=":'158',
                       "Boiling_point(Celcius) = " :'767',
                       "Melting_point(Celcius) =":'321.07',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'867.8',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '2310',
                       "Latent heat of Fusion (KJ/mol)=":'6.3',
                       "Latent heat of Vapourization (kJ/mol)=":'100',
                       "Specific heat (J/kgK)=":'240',
                       "Thermal conductivity (W/m K)=":'97',
                       "Electronegetivity=":'1.69',
                       "Neutron cross-section (barn)=":'2450'
                       }
...
def In_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Indium(In)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1863)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=49 , Group=13 ,Period=5 ,Block= p , CAS Number=7440-74-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'114.818' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'156',
                       "Covelent_radius(pm) = ":'142' ,
                       "Van der waals radius (pm)=":'193',
                       "Boiling_point(Celcius) = " :'2072',
                       "Melting_point(Celcius) =":'156.6',
                       "Electron_affinity( kj / mol) = ":'28.9',
                       "First ionization energy (kJ/mol)=":'558.3',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '1215',
                       "Latent heat of Fusion (KJ/mol)=":'3.26',
                       "Latent heat of Vapourization (kJ/mol)=":'230',
                       "Specific heat (J/kgK)=":'233',
                       "Thermal conductivity (W/m K)=":'82',
                       "Electronegetivity=":'1.78',
                       "Neutron cross-section (barn)=":'194'
                       }
...
def Sn_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Tin(Sn)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 3000 BC)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=50 , Group=14 ,Period=5 ,Block= p , CAS Number=7440-31-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'118.71' ,
                       "Oxidation_state = ":'[+2,+4]' ,
                       "Atomic_radius (pm)= ":'145',
                       "Covelent_radius(pm) = ":'139' ,
                       "Van der waals radius (pm)=":'217',
                       "Boiling_point(Celcius) = " :'2602',
                       "Melting_point(Celcius) =":'231.93',
                       "Electron_affinity( kj / mol) = ":'107.3',
                       "First ionization energy (kJ/mol)=":'708.6',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '2500',
                       "Latent heat of Fusion (KJ/mol)=":'7',
                       "Latent heat of Vapourization (kJ/mol)=":'290',
                       "Specific heat (J/kgK)=":'217',
                       "Thermal conductivity (W/m K)=":'67',
                       "Electronegetivity=":'1.96',
                       "Neutron cross-section (barn)=":'0.63'
                       }
...
def Sb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Antimony(Sb)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 3000 BC)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=51 , Group=15 ,Period=5 ,Block= p , CAS Number=7440-36-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'121.76' ,
                       "Oxidation_state = ":'[-3,+3,+5]' ,
                       "Atomic_radius (pm)= ":'133',
                       "Covelent_radius(pm) = ":'139' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'1587',
                       "Melting_point(Celcius) =":'630.63',
                       "Electron_affinity( kj / mol) = ":'103.2',
                       "First ionization energy (kJ/mol)=":'834',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '3420',
                       "Latent heat of Fusion (KJ/mol)=":'19.7',
                       "Latent heat of Vapourization (kJ/mol)=":'68',
                       "Specific heat (J/kgK)=":'207',
                       "Thermal conductivity (W/m K)=":'24',
                       "Electronegetivity=":'2.05',
                       "Neutron cross-section (barn)=":'5.4'
                       }
...
def Te_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Tellurium(Te)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1783)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=52 , Group=16 ,Period=5 ,Block= p , CAS Number=13494-80-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'127.6' ,
                       "Oxidation_state = ":'[-2,+2,+4,+6]' ,
                       "Atomic_radius (pm)= ":'123',
                       "Covelent_radius(pm) = ":'138' ,
                       "Van der waals radius (pm)=":'206',
                       "Boiling_point(Celcius) = " :'988',
                       "Melting_point(Celcius) =":'449.51',
                       "Electron_affinity( kj / mol) = ":'190.2',
                       "First ionization energy (kJ/mol)=":'869.3',
                       "Refractive_index = ": '1.000991',
                       "Speed_of_sound( m/s) = ": '2610',
                       "Latent heat of Fusion (KJ/mol)=":'17.5',
                       "Latent heat of Vapourization (kJ/mol)=":'48',
                       "Specific heat (J/kgK)=":'201',
                       "Thermal conductivity (W/m K)=":'3',
                       "Electronegetivity=":'2.1',
                       "Neutron cross-section (barn)=":'5.4',
                       }
...
def I_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Iodine(I)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1817)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=53, Group=17,Period=5 ,Block= p , CAS Number=7553-56-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'126.90447',
                       "Oxidation_state = ":'[-1,+1,+5,+7]',
                       "Atomic_radius (pm)= ":'115',
                       "Covelent_radius(pm) = ":'139' ,
                       "Van der waals radius (pm)=":'198',
                       "Boiling_point(Celcius) = " :'184.3',
                       "Melting_point(Celcius) =":'113.7',
                       "Electron_affinity( kj / mol) = ":'295.2',
                       "First ionization energy (kJ/mol)=":'1008.4',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '----',
                       "Latent heat of Fusion (KJ/mol)=":'7.76',
                       "Latent heat of Vapourization (kJ/mol)=":'20.9',
                       "Specific heat (J/kgK)=":'429',
                       "Thermal conductivity (W/m K)=":'0.449',
                       "Electronegetivity=":'2.66',
                       "Neutron cross-section (barn)=":'6.2'
                       }
...
def Xe_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Xenon(Xe)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1898)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=54 , Group=18 ,Period=5 ,Block= p , CAS Number=7440-63-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'131.293' ,
                       "Oxidation_state = ":'[0,+2,+4,+6,+8]' ,
                       "Atomic_radius (pm)= ":'108',
                       "Covelent_radius(pm) = ":'140' ,
                       "Van der waals radius (pm)=":'216',
                       "Boiling_point(Celcius) = " :'-108',
                       "Melting_point(Celcius) =":'-111.8',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'1170.4',
                       "Refractive_index = ": '1.000702',
                       "Speed_of_sound( m/s) = ": '1090',
                       "Latent heat of Fusion (KJ/mol)=":'2.3',
                       "Latent heat of Vapourization (kJ/mol)=":'12.64',
                       "Specific heat (J/kgK)=":'158.32',
                       "Thermal conductivity (W/m K)=":'0.00565',
                       "Electronegetivity=":'2.6',
                       "Neutron cross-section (barn)=":'25'
                       }
...
def Cs_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Ceasium(Cs)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1860)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=55 , Group=1 ,Period=6 ,Block= S , CAS Number=7440-46-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'132.90545196' ,
                       "Oxidation_state = ":'[+1]' ,
                       "Atomic_radius (pm)= ":'298',
                       "Covelent_radius(pm) = ":'244' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'671',
                       "Melting_point(Celcius) =":'28.44',
                       "Electron_affinity( kj / mol) = ":'45.5',
                       "First ionization energy (kJ/mol)=":'375.7',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'2.09',
                       "Latent heat of Vapourization (kJ/mol)=":'65',
                       "Specific heat (J/kgK)=":'242',
                       "Thermal conductivity (W/m K)=":'36',
                       "Electronegetivity=":'0.79',
                       "Neutron cross-section (barn)=":'29'
                       }
...
def Ba_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Barium(Ba)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1808)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=56 , Group=2 ,Period=6 ,Block= s , CAS Number=7440-39-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'137.327' ,
                       "Oxidation_state = ":'[+2]' ,
                       "Atomic_radius (pm)= ":'253',
                       "Covelent_radius(pm) = ":'215' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'1870',
                       "Melting_point(Celcius) =":'727',
                       "Electron_affinity( kj / mol) = ":'13.95',
                       "First ionization energy (kJ/mol)=":'502.9',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '1620',
                       "Latent heat of Fusion (KJ/mol)=":'8',
                       "Latent heat of Vapourization (kJ/mol)=":'140',
                       "Specific heat (J/kgK)=":'205',
                       "Thermal conductivity (W/m K)=":'18',
                       "Electronegetivity=":'0.89',
                       "Neutron cross-section (barn)=":'1.3'
                       }
...
def La_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Lanthanum(La)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1839)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=57 , Group=n/a ,Period=6 ,Block= f , CAS Number=7439-91-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'138.90547' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'---',
                       "Covelent_radius(pm) = ":'207' ,
                       "Van der waals radius (pm)=":'----',
                       "Boiling_point(Celcius) = " :'3464',
                       "Melting_point(Celcius) =":'920',
                       "Electron_affinity( kj / mol) = ":'1.1',
                       "First ionization energy (kJ/mol)=":'538.1',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '2475',
                       "Latent heat of Fusion (KJ/mol)=":'6.2',
                       "Latent heat of Vapourization (kJ/mol)=":'400',
                       "Specific heat (J/kgK)=":'195',
                       "Thermal conductivity (W/m K)=":'13',
                       "Electronegetivity=":'1.1',
                       "Neutron cross-section (barn)=":'8.98'
                       }
...
def Ce_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Cerium(Ce)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1803)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=58 , Group=n/a ,Period=6 ,Block= f , CAS Number=7440-45-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'140.116' ,
                       "Oxidation_state = ":'[+3,+4]' ,
                       "Atomic_radius (pm)= ":'----',
                       "Covelent_radius(pm) = ":'204' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3360',
                       "Melting_point(Celcius) =":'798',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'534.4',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '2100',
                       "Latent heat of Fusion (KJ/mol)=":'5.5',
                       "Latent heat of Vapourization (kJ/mol)=":'350',
                       "Specific heat (J/kgK)=":'192',
                       "Thermal conductivity (W/m K)=":'11',
                       "Electronegetivity=":'1.12',
                       "Neutron cross-section (barn)=":'0.6'
                       }
...
def Pr_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Praseodymium(Pr)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1885)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=59 , Group=n/a ,Period=6 ,Block= f , CAS Number=7440-10-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'140.90766' ,
                       "Oxidation_state = ":'[+3,+4]' ,
                       "Atomic_radius (pm)= ":'247',
                       "Covelent_radius(pm) = ":'203' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3290',
                       "Melting_point(Celcius) =":'931',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'527',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '2280',
                       "Latent heat of Fusion (KJ/mol)=":'6.9',
                       "Latent heat of Vapourization (kJ/mol)=":'330',
                       "Specific heat (J/kgK)=":'193',
                       "Thermal conductivity (W/m K)=":'13',
                       "Electronegetivity=":'1.13',
                       "Neutron cross-section (barn)=":'11.4'
                       }
...
def Nd_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Neodymium(Nd)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1885)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=60 , Group=n/a ,Period=6 ,Block= f , CAS Number=7440-00-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'144.242' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'206',
                       "Covelent_radius(pm) = ":'201' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3100',
                       "Melting_point(Celcius) =":'1021',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'533.1',
                       "Refractive_index = ": '----',
                       "Speed_of_sound( m/s) = ": '2330',
                       "Latent heat of Fusion (KJ/mol)=":'7.1',
                       "Latent heat of Vapourization (kJ/mol)=":'285',
                       "Specific heat (J/kgK)=":'190',
                       "Thermal conductivity (W/m K)=":'17',
                       "Electronegetivity=":'1.14',
                       "Neutron cross-section (barn)=":'49'
                       }
...
def Pm_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Promethium(Pm):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1945)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=61 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-12-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'145' ,
                       "Oxidation_state = ":'+3' ,
                       "Atomic_radius (pm)= ":'205',
                       "Covelent_radius(pm) = ":'199' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'3000',
                       "Melting_point(Celcius) =":'1100',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'540',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '--',
                       "Latent heat of Fusion (KJ/mol)=":'7.7',
                       "Latent heat of Vapourization (kJ/mol)=":'290',
                       "Specific heat (J/kgK)=":'--',
                       "Thermal conductivity (W/m K)=":'15',
                       "Electronegetivity=":'--',
                       "Neutron cross-section (barn)=":'8400'
                       }
...
def Sm_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Samarium(Sm):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1879)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=62 , Group=0 ,Period=6 ,Block= f, CAS Number=7440-19-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'150.36' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'238',
                       "Covelent_radius(pm) = ":'198' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1803',
                       "Melting_point(Celcius) =":'1072',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'544.5',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2130',
                       "Latent heat of Fusion (KJ/mol)=":'8.6',
                       "Latent heat of Vapourization (kJ/mol)=":'175',
                       "Specific heat (J/kgK)=":'196',
                       "Thermal conductivity (W/m K)=":'13',
                       "Electronegetivity=":'1.17',
                       "Neutron cross-section (barn)=":'5900'
                       }
...
def Eu_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Europium(Eu):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1901)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=63 , Group=0 ,Period=6 ,Block=f , CAS Number=7440-53-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'151.964' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'231',
                       "Covelent_radius(pm) = ":'198' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1527',
                       "Melting_point(Celcius) =":'822',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'547.1',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1270',
                       "Latent heat of Fusion (KJ/mol)=":'9.2',
                       "latent heat of Vapourization (kJ/mol)=":'175',
                       "Specific heat (J/kgK)=":'182',
                       "Thermal conductivity (W/m K)=":'14',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'4570'
                       }
...
def Gd_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Gadolinium(Gd):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1880)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=64 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-54-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'157.25' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'233',
                       "Covelent_radius(pm) = ":'196' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'3250',
                       "Melting_point(Celcius) =":'1313',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'593.4',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2680',
                       "Latent heat of Fusion (KJ/mol)=":'10',
                       "Latent heat of Vapourization (kJ/mol)=":'305',
                       "Specific heat (J/kgK)=":'240',
                       "Thermal conductivity (W/m K)=":'11',
                       "Electronegetivity=":'2.2',
...
def Tb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Terbium(Tb):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1843)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=65 , Group=0 ,Period=6 ,Block= f , CAS Number=74440-27-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'158.92535' ,
                       "Oxidation_state = ":'[+3,+4]' ,
                       "Atomic_radius (pm)= ":'225',
                       "Covelent_radius(pm) = ":'194' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'3230',
                       "Melting_point(Celcius) =":'1356',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'565.8',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2620',
                       "Latent heat of Fusion (KJ/mol)=":'10.8',
                       "Latent heat of Vapourization (kJ/mol)=":'295',
                       "Specific heat (J/kgK)=":'182',
                       "Thermal conductivity (W/m K)=":'0.1805',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'23'
                       }
...
def Dy_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Dysprosium(Dy):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1886)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=66 , Group=0 ,Period=6 ,Block= f , CAS Number=7429-91-6')    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'162.5' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'228',
                       "Covelent_radius(pm) = ":'192' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'2567',
                       "Melting_point(Celcius) =":'1412',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'573',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2710',
                       "Latent heat of Fusion (KJ/mol)=":'11.1',
                       "Latent heat of Vapourization (kJ/mol)=":'280',
                       "Specific heat (J/kgK)=":'167',
                       "Thermal conductivity (W/m K)=":'11',
                       "Electronegetivity=":'1.22',
                       "Neutron cross-section (barn)=":'950'
                       }
...
def Ho_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Holmium(Ho):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1878)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=67 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-60-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'164.93033' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'226',
                       "Covelent_radius(pm) = ":'192' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'2700',
                       "Melting_point(Celcius) =":'1474',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'581',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2760',
                       "Latent heat of Fusion (KJ/mol)=":'17',
                       "Latent heat of Vapourization (kJ/mol)=":'265',
                       "Specific heat (J/kgK)=":'165',
                       "Thermal conductivity (W/m K)=":'16',
                       "Electronegetivity=":'1.23',
                       "Neutron cross-section (barn)=":'65'
                       }
...
def Er_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Erbium(Er):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1842)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=68 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-52-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'167.259' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'266',
                       "Covelent_radius(pm) = ":'189' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'2868',
                       "Melting_point(Celcius) =":'1497',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'589.3',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2830',
                       "Latent heat of Fusion (KJ/mol)=":'19.9',
                       "Latent heat of Vapourization (kJ/mol)=":'285',
                       "Specific heat (J/kgK)=":'168',
                       "Thermal conductivity (W/m K)=":'15',
                       "Electronegetivity=":'1.24',
                       "Neutron cross-section (barn)=":'165'
                       }
...
def Tm_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Thulium(Tm):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1879)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=69 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-30-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'168.93422' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'222',
                       "Covelent_radius(pm) = ":'190' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1950',
                       "Melting_point(Celcius) =":'1545',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'596.7',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '--',
                       "Latent heat of Fusion (KJ/mol)=":'16.8',
                       "Latent heat of Vapourization (kJ/mol)=":'250',
                       "Specific heat (J/kgK)=":'160',
                       "Thermal conductivity (W/m K)=":'17',
                       "Electronegetivity=":'1.25',
                       "Neutron cross-section (barn)=":'105'
                       }
...
def Yb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Ytterbium(Yb):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1878)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=70 , Group=0 ,Period=6 ,Block= f , CAS Number=7440-64-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'173.045' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'222',
                       "Covelent_radius(pm) = ":'187' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1196',
                       "Melting_point(Celcius) =":'819',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'603.4',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1590',
                       "Latent heat of Fusion (KJ/mol)=":'7.7',
                       "Latent heat of Vapourization (kJ/mol)=":'160',
                       "Specific heat (J/kgK)=":'154',
                       "Thermal conductivity (W/m K)=":'39',
                       "Electronegetivity=":'--',
                       "Neutron cross-section (barn)=":'35'
                       }
...
def Lu_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Lutetium(Lu):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1907)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=71 , Group=0 ,Period=6 ,Block= d , CAS Number=7439-94-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'174.9668' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'217',
                       "Covelent_radius(pm) = ":'187' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'3402',
                       "Melting_point(Celcius) =":'1663',
                       "Electron_affinity( kj / mol) = ":'50',
                       "First ionization energy (kJ/mol)=":'523.5',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1270',
                       "Latent heat of Fusion (KJ/mol)=":'22',
                       "Latent heat of Vapourization (kJ/mol)=":'415',
                       "Specific heat (J/kgK)=":'154',
                       "Thermal conductivity (W/m K)=":'16',
                       "Electronegetivity=":'1.27',
                       "Neutron cross-section (barn)=":'84'
                       }
...
def Hf_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Hafnium(Hf):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1923)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=72 , Group=4 ,Period=6 ,Block= d , CAS Number=7440-58-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'178.49' ,
                       "Oxidation_state = ":'[+4]' ,
                       "Atomic_radius (pm)= ":'208',
                       "Covelent_radius(pm) = ":'175' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'4608',
                       "Melting_point(Celcius) =":'2233',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'658.5',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '3010',
                       "Latent heat of Fusion (KJ/mol)=":'25.5',
                       "Latent heat of Vapourization (kJ/mol)=":'630',
                       "Specific heat (J/kgK)=":'144',
                       "Thermal conductivity (W/m K)=":'23',
                       "Electronegetivity=":'1.3',
...
def Ta_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Tantalum(Ta):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1802)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=73 , Group=5 ,Period=6 ,Block= d , CAS Number=7440-25-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'180.94788' ,
                       "Oxidation_state = ":'[+5]' ,
                       "Atomic_radius (pm)= ":'200',
                       "Covelent_radius(pm) = ":'170' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'5458',
                       "Melting_point(Celcius) =":'3017',
                       "Electron_affinity( kj / mol) = ":'31',
                       "First ionization energy (kJ/mol)=":'761',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '3400',
                       "Latent heat of Fusion (KJ/mol)=":'36',
                       "Latent heat of Vapourization (kJ/mol)=":'735',
                       "Specific heat (J/kgK)=":'140',
                       "Thermal conductivity (W/m K)=":'57',
                       "Electronegetivity=":'1.5',
                       "Neutron cross-section (barn)=":'20.5'
                       }
...
def W_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Tungsten(W):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1783)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=74 , Group=6 ,Period=6 ,Block= d , CAS Number=7440-33-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'183.84' ,
                       "Oxidation_state = ":'[-2,-1,+2,+3,+4,+5,+6]' ,
                       "Atomic_radius (pm)= ":'193',
                       "Covelent_radius(pm) = ":'162' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'5555',
                       "Melting_point(Celcius) =":'3422',
                       "Electron_affinity( kj / mol) = ":'78.6',
                       "First ionization energy (kJ/mol)=":'770',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '5174',
                       "Latent heat of Fusion (KJ/mol)=":'35',
                       "Latent heat of Vapourization (kJ/mol)=":'800',
                       "Specific heat (J/kgK)=":'132',
                       "Thermal conductivity (W/m K)=":'170',
                       "Electronegetivity=":'2.36',
                       "Neutron cross-section (barn)=":'18.4'
                       }
...
def Re_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Rhenium(Re):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1925')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=75 , Group=7 ,Period=6 ,Block= d , CAS Number=7440-15-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'186.207' ,
                       "Oxidation_state = ":'[-1,+2,+4,+6,+7]' ,
                       "Atomic_radius (pm)= ":'188',
                       "Covelent_radius(pm) = ":'151' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'5596',
                       "Melting_point(Celcius) =":'3186',
                       "Electron_affinity( kj / mol) = ":'14.5',
                       "First ionization energy (kJ/mol)=":'760',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '4700',
                       "Latent heat of Fusion (KJ/mol)=":'33',
                       "Latent heat of Vapourization (kJ/mol)=":'705',
                       "Specific heat (J/kgK)=":'137',
                       "Thermal conductivity (W/m K)=":'48',
                       "Electronegetivity=":'1.9',
                       "Neutron cross-section (barn)=":'90'
                       }
...
def Os_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Osmium(Os):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1803)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=76 , Group=8 ,Period=6 ,Block= d , CAS Number=7440-04-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'190.23' ,
                       "Oxidation_state = ":'[-2,+2,+3,+4,+6,+8]' ,
                       "Atomic_radius (pm)= ":'185',
                       "Covelent_radius(pm) = ":'144' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'5012',
                       "Melting_point(Celcius) =":'3033',
                       "Electron_affinity( kj / mol) = ":'106.1',
                       "First ionization energy (kJ/mol)=":'840',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '4940',
                       "Latent heat of Fusion (KJ/mol)=":'31',
                       "Latent heat of Vapourization (kJ/mol)=":'630',
                       "Specific heat (J/kgK)=":'130',
                       "Thermal conductivity (W/m K)=":'88',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'15'
                       }
...
def Ir_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Iridium(Ir):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1803)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=77 , Group=9 ,Period=6 ,Block= d , CAS Number=7439-88-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'192.217' ,
                       "Oxidation_state = ":'[-1,+1,+2,+3,+4,+6]' ,
                       "Atomic_radius (pm)= ":'180',
                       "Covelent_radius(pm) = ":'141' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'4428',
                       "Melting_point(Celcius) =":'2466',
                       "Electron_affinity( kj / mol) = ":'151',
                       "First ionization energy (kJ/mol)=":'880',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '4825',
                       "Latent heat of Fusion (KJ/mol)=":'26',
                       "Latent heat of Vapourization (kJ/mol)=":'560',
                       "Specific heat (J/kgK)=":'131',
                       "Thermal conductivity (W/m K)=":'150',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'425'
                       }
...
def Pt_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Platinum(Pt):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1735)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=78 , Group=10 ,Period=6 ,Block= d , CAS Number=7440-06-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'195.084' ,
                       "Oxidation_state = ":'[+2,+4]' ,
                       "Atomic_radius (pm)= ":'177',
                       "Covelent_radius(pm) = ":'136' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'3825',
                       "Melting_point(Celcius) =":'1768.3',
                       "Electron_affinity( kj / mol) = ":'205.3',
                       "First ionization energy (kJ/mol)=":'870',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '2680',
                       "Latent heat of Fusion (KJ/mol)=":'20',
                       "Latent heat of Vapourization (kJ/mol)=":'490',
                       "Specific heat (J/kgK)=":'133',
                       "Thermal conductivity (W/m K)=":'72',
                       "Electronegetivity=":'2.28',
                       "Neutron cross-section (barn)=":'10'
                       }
...
def Au_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Gold(Au):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : -2500)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=79 , Group=11 ,Period=6 ,Block= d , CAS Number=7440-57-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'196.966569' ,
                       "Oxidation_state = ":'[+1,+3]' ,
                       "Atomic_radius (pm)= ":'174',
                       "Covelent_radius(pm) = ":'136' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'2856',
                       "Melting_point(Celcius) =":'1064.18',
                       "Electron_affinity( kj / mol) = ":'222.8',
                       "First ionization energy (kJ/mol)=":'890.1',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1740',
                       "Latent heat of Fusion (KJ/mol)=":'12.5',
                       "Latent heat of Vapourization (kJ/mol)=":'330',
                       "Specific heat (J/kgK)=":'129.1',
                       "Thermal conductivity (W/m K)=":'320',
                       "Electronegetivity=":'2.54',
                       "Neutron cross-section (barn)=":'98.7'
                       }
...
def Hg_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Mercury(Hg):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : -1500)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=80 , Group=12 ,Period=6 ,Block= d , CAS Number=7439-97-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'200.592' ,
                       "Oxidation_state = ":'[+1,+2]' ,
                       "Atomic_radius (pm)= ":'171',
                       "Covelent_radius(pm) = ":'132' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'356.73',
                       "Melting_point(Celcius) =":'-38.83',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'1007.1',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1407',
                       "Latent heat of Fusion (KJ/mol)=":'2.29',
                       "Latent heat of Vapourization (kJ/mol)=":'59.2',
                       "Specific heat (J/kgK)=":'59.2',
                       "Thermal conductivity (W/m K)=":'8.3',
                       "Electronegetivity=":'2',
                       "Neutron cross-section (barn)=":'374'
                       }
...
def Tl_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Thallium(Tl):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1861)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=81 , Group=13 ,Period=6 ,Block= p , CAS Number=7440-28-0')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'204.38' ,
                       "Oxidation_state = ":'[+1,+3]' ,
                       "Atomic_radius (pm)= ":'156',
                       "Covelent_radius(pm) = ":'145' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1473',
                       "Melting_point(Celcius) =":'304',
                       "Electron_affinity( kj / mol) = ":'19.2',
                       "First ionization energy (kJ/mol)=":'589.4',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '818',
                       "Latent heat of Fusion (KJ/mol)=":'4.2',
                       "Latent heat of Vapourization (kJ/mol)=":'165',
                       "Specific heat (J/kgK)=":'129',
                       "Thermal conductivity (W/m K)=":'46',
                       "Electronegetivity=":'1.62',
                       "Neutron cross-section (barn)=":'3.4'
                       }
...
def Pb_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Lead(Pb):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 4000 BC)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=82 , Group=14 ,Period=6 ,Block= p , CAS Number=7439-92-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'207.2' ,
                       "Oxidation_state = ":'[+2,+4]' ,
                       "Atomic_radius (pm)= ":'154',
                       "Covelent_radius(pm) = ":'146' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1749',
                       "Melting_point(Celcius) =":'327.46',
                       "Electron_affinity( kj / mol) = ":'35.1',
                       "First ionization energy (kJ/mol)=":'715.6',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1260',
                       "Latent heat of Fusion (KJ/mol)=":'4.77',
                       "Latent heat of Vapourization (kJ/mol)=":'178',
                       "Specific heat (J/kgK)=":'127',
                       "Thermal conductivity (W/m K)=":'35',
                       "Electronegetivity=":'2.33',
                       "Neutron cross-section (barn)=":'0.171'
                       }
...
def Bi_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Bismuth(Bi):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1400)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=83 , Group=15 ,Period=6 ,Block= p , CAS Number=7440-69-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'208.9804' ,
                       "Oxidation_state = ":'[+3,+5]' ,
                       "Atomic_radius (pm)= ":'143',
                       "Covelent_radius(pm) = ":'148' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1546',
                       "Melting_point(Celcius) =":'271.3',
                       "Electron_affinity( kj / mol) = ":'91.2',
                       "First ionization energy (kJ/mol)=":'703',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '1790',
                       "Latent heat of Fusion (KJ/mol)=":'10.9',
                       "Latent heat of Vapourization (kJ/mol)=":'160',
                       "Specific heat (J/kgK)=":'122',
                       "Thermal conductivity (W/m K)=":'8',
                       "Electronegetivity=":'2.02',
                       "Neutron cross-section (barn)=":'0.034'
                       }
...
def Po_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Polonium(Po):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1898)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=84 , Group=16 ,Period=6 ,Block= p , CAS Number=7440-08-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'209' ,
                       "Oxidation_state = ":'[+2,+4]' ,
                       "Atomic_radius (pm)= ":'135',
                       "Covelent_radius(pm) = ":'140' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'962',
                       "Melting_point(Celcius) =":'254',
                       "Electron_affinity( kj / mol) = ":'183.3',
                       "First ionization energy (kJ/mol)=":'812.1',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '--',
                       "Latent heat of Fusion (KJ/mol)=":'13',
                       "Latent heat of Vapourization (kJ/mol)=":'100',
                       "Specific heat (J/kgK)=":'--',
                       "Thermal conductivity (W/m K)=":'0.1805',
                       "Electronegetivity=":'2',
                       "Neutron cross-section (barn)=":'0.5'
                       }
...
def At_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Astatine(At):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1940)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=85 , Group=17 ,Period=6 ,Block= p , CAS Number=7440-68-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'210' ,
                       "Oxidation_state = ":'[-1,+1,+3,+5,+7]' ,
                       "Atomic_radius (pm)= ":'127',
                       "Covelent_radius(pm) = ":'150' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'1342',
                       "Melting_point(Celcius) =":'302',
                       "Electron_affinity( kj / mol) = ":'270.1',
                       "First ionization energy (kJ/mol)=":'920',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '--',
                       "Latent heat of Fusion (KJ/mol)=":'6',
                       "Latent heat of Vapourization (kJ/mol)=":'40',
                       "Specific heat (J/kgK)=":'--',
...
def Rn_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Radon(Rn):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1900)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=86 , Group=18 ,Period=6 ,Block= p , CAS Number=10043-92-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'222' ,
                       "Oxidation_state = ":'[0,+2]' ,
                       "Atomic_radius (pm)= ":'120',
                       "Covelent_radius(pm) = ":'150' ,
                       "Van der waals radius (pm)=":'--',
                       "Boiling_point(Celcius) = " :'-61.7',
                       "Melting_point(Celcius) =":'-71',
                       "Electron_affinity( kj / mol) = ":'0',
                       "First ionization energy (kJ/mol)=":'1037',
                       "Refractive_index = ": '--',
                       "Speed_of_sound( m/s) = ": '--',
                       "Latent heat of Fusion (KJ/mol)=":'3',
                       "Latent heat of Vapourization (kJ/mol)=":'17',
                       "Specific heat (J/kgK)=":'93.65',
                       "Thermal conductivity (W/m K)=":'0.00361',
                       "Electronegetivity=":'2.2',
                       "Neutron cross-section (barn)=":'0.7'
                       }
...
def Fr_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Francium(Fr)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1939)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=87 , Group=1 ,Period=7 ,Block= S , CAS Number=7440-73-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'223.0' ,
                       "Oxidation_state = ":'[+1]' ,
                       "Atomic_radius (pm)= ":'290',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'348',
                       "Boiling_point(Celcius) = " :'676.8',
                       "Melting_point(Celcius) =":'8.0',
                       "Electron_affinity( kj / mol) = ":'1',
                       "First ionization energy (kJ/mol)=":'380',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'2',
                       "Latent heat of Vapourization (kJ/mol)=":'65',
                       "Specific heat (J/kgK)=":'---',
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'0.7',
                       "Neutron cross-section (barn)=":'0'
                       }
...
def Ra_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Radium(Ra)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1898)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=88 , Group=2 ,Period=7 ,Block= S , CAS Number=7440-14-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'226.02' ,
                       "Oxidation_state = ":'[+2]' ,
                       "Atomic_radius (pm)= ":'215',
                       "Covelent_radius(pm) = ":'221' ,
                       "Van der waals radius (pm)=":'283',
                       "Boiling_point(Celcius) = " :'1737.0',
                       "Melting_point(Celcius) =":'696.0',
                       "Electron_affinity( kj / mol) = ":'2',
                       "First ionization energy (kJ/mol)=":'509.3',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'8',
                       "Latent heat of Vapourization (kJ/mol)=":'125',
                       "Specific heat (J/kgK)=":'92',
                       "Thermal conductivity (W/m K)=":'19',
                       "Electronegetivity=":'0.9',
                       "Neutron cross-section (barn)=":'20'
                       }
...
def Ac_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Actinium(Ac)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1899)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=89 , Group=3 ,Period=7 ,Block= d , CAS Number=7440-34-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'(227)' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'188',
                       "Covelent_radius(pm) = ":'215 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3200',
                       "Melting_point(Celcius) =":'1050',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'499',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'14',
                       "Latent heat of Vapourization (kJ/mol)=":'400',
                       "Specific heat (J/kgK)=":'120',
                       "Thermal conductivity (W/m K)=":'12',
                       "Electronegetivity=":'1.1',
                       "Neutron cross-section (barn)=":'810'
                       }
...
def Th_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Thorium(Th)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1828)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=90 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-29-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'232.03' ,
                       "Oxidation_state = ":'[+2, +3, +4]' ,
                       "Atomic_radius (pm)= ":'180',
                       "Covelent_radius(pm) = ":'206 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'4787.0',
                       "Melting_point(Celcius) =":'1750',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'587',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '2490',
                       "Latent heat of Fusion (KJ/mol)=":'16',
                       "Latent heat of Vapourization (kJ/mol)=":'530',
                       "Specific heat (J/kgK)=":'118',
                       "Thermal conductivity (W/m K)=":'54',
                       "Electronegetivity=":'1.3',
...
def Pa_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Protoactinium(Pa)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1918)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=91 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-13-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'231.03' ,
                       "Oxidation_state = ":'[+3,+4,+5]' ,
                       "Atomic_radius (pm)= ":'161',
                       "Covelent_radius(pm) = ":'206 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'4027.0',
                       "Melting_point(Celcius) =":'1840.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'587',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'15',
                       "Latent heat of Vapourization (kJ/mol)=":'470',
                       "Specific heat (J/kgK)=":'99.1',
                       "Thermal conductivity (W/m K)=":'47',
                       "Electronegetivity=":'1.5',
                       "Neutron cross-section (barn)=":'500'
                       }
...
def U_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Uranium(U)')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1789)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=92 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-61-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'238.02' ,
                       "Oxidation_state = ":'[+3,+4,+5,+6]' ,
                       "Atomic_radius (pm)= ":'138',
                       "Covelent_radius(pm) = ":'196 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'186',
                       "Boiling_point(Celcius) = " :'4131.0',
                       "Melting_point(Celcius) =":'1132.4',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'587',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '3155',
                       "Latent heat of Fusion (KJ/mol)=":'14',
                       "Latent heat of Vapourization (kJ/mol)=":'420',
                       "Specific heat (J/kgK)=":'116',
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'1.38',
                       "Neutron cross-section (barn)=":'7.57'
                       }
...
def Np_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Neptunium(Np):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1940)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=93 , Group=3 ,Period=7 ,Block= f , CAS Number=7439-99-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'237.04' ,
                       "Oxidation_state = ":'[+3,+4,+5,+6,+7]' ,
                       "Atomic_radius (pm)= ":'130',
                       "Covelent_radius(pm) = ":'190 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'4000',
                       "Melting_point(Celcius) =":'644',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'604.5',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'10',
                       "Latent heat of Vapourization (kJ/mol)=":'335',
                       "Specific heat (J/kgK)=":'---',
                       "Thermal conductivity (W/m K)=":'6',
                       "Electronegetivity=":'1.36',
                       "Neutron cross-section (barn)=":'180'
                       }
...
def Pu_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Plutonium(Pu):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1940)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=94 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-07-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'244.06' ,
                       "Oxidation_state = ":'[+3,+4,+5,+6,+7]' ,
                       "Atomic_radius (pm)= ":'162',
                       "Covelent_radius(pm) = ":'187' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3232.0',
                       "Melting_point(Celcius) =":'641.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'584.7',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '2260',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'325',
                       "Specific heat (J/kgK)=":'---',
                       "Thermal conductivity (W/m K)=":'6',
                       "Electronegetivity=":'1.28',
                       "Neutron cross-section (barn)=":'1.7'
                       }
...
def Am_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Americium(Am):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1944)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=95 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-35-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'243.06' ,
                       "Oxidation_state = ":'[+2,+3,+4,+5,+6]' ,
                       "Atomic_radius (pm)= ":'173',
                       "Covelent_radius(pm) = ":'180' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'2607.0',
                       "Melting_point(Celcius) =":'1176.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'578',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
                       "Specific heat (J/kgK)=":'---',
                       "Thermal conductivity (W/m K)=":'10',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'74'
                       }
...
def Cm_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Curium(Cm):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1944)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=96 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-51-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'247.07' ,
                       "Oxidation_state = ":'[+3,+4]' ,
                       "Atomic_radius (pm)= ":'299',
                       "Covelent_radius(pm) = ":'169 (0.16%  error)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'3110.0',
                       "Melting_point(Celcius) =":'1340',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'581',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'13.85',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
                       "Specific heat (J/kgK)=":'---',
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'60'
                       }
...
def Bk_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Berkelium(Bk):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1949)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=97 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-40-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    atomic_properties={"Atomic_weight (g / mol) = ":'247.07' ,
                       ...
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'2627.0',
                       "Melting_point(Celcius) =":'986.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       ...
                       "Thermal conductivity (W/m K)=":'10',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'710'
                       }
...
def Cf_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Californium(Cf):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1950)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=98 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-71-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'251.07' ,
                       "Oxidation_state = ":'[+2,+3,+4]' ,
                       "Atomic_radius (pm)= ":'295',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'1472.0',
                       "Melting_point(Celcius) =":'900.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'608',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
                       ...
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'2900'
                       }
...
def Es_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Einsteinium(Es):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1952)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=99 , Group=3 ,Period=7 ,Block= f , CAS Number=7429-92-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'252.08' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'292',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'860.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       ...
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'160'
                       }
...
def Fm_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Fermium(Fm):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1952)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=100 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-72-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'257.09' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'290',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'1525',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'629',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
                       ...
                       "Thermal conductivity (W/m K)=":'---',
                       "Electronegetivity=":'1.3',
                       "Neutron cross-section (barn)=":'5800'
                       }
...
def Md_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Mendelivium(Md):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1955)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=101 , Group=3 ,Period=7 ,Block= f , CAS Number=7440-11-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'258.09' ,
                       "Oxidation_state = ":'[+2,+3]' ,
                       "Atomic_radius (pm)= ":'287',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'825.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'636',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def No_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Nobelium(No):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1965)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=102 , Group=3 ,Period=7 ,Block= f , CAS Number=10028-14-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'259.10' ,
                       "Oxidation_state = ":'[+2,+3]' ,
...
def Lr_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Lawrencium(Lr):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1961)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=103 , Group=3 ,Period=7 ,Block= f , CAS Number=22537-19-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'266.11' ,
                       "Oxidation_state = ":'[+3]' ,
                       "Atomic_radius (pm)= ":'282',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'1625.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'---',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '1270',
...
def Rf_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Rutherfordium(Rf):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1964)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=104 , Group=4 ,Period=7 ,Block= d , CAS Number=53850-36-5')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'261.10' ,
                       "Oxidation_state = ":'[+4]' ,
                       "Atomic_radius (pm)= ":'150 (predicted)',
                       "Covelent_radius(pm) = ":'157 (predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'5500.0',
                       "Melting_point(Celcius) =":'2100.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'580',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Db_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Dubnium(Db):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1968)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=105 , Group=5 ,Period=7 ,Block= d , CAS Number=53850-35-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'262.11' ,
                       "Oxidation_state = ":'[+5]' ,
                       "Atomic_radius (pm)= ":'139 (predicted)',
                       "Covelent_radius(pm) = ":'149 (predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'665',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Sg_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Seaborgium(Sg):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1974)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=106 , Group=6 ,Period=7 ,Block= d , CAS Number=54038-81-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'263.11' ,
                       "Oxidation_state = ":'[+6]' ,
                       "Atomic_radius (pm)= ":'132(predicted)',
                       "Covelent_radius(pm) = ":'143 (predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'757',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Bh_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Bohrium(Bh):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1981)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=107 , Group=7 ,Period=7 ,Block= d , CAS Number=54037-14-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'262.122' ,
                       "Oxidation_state = ":'[+7]' ,
                       "Atomic_radius (pm)= ":'128 (predicted)',
                       "Covelent_radius(pm) = ":'141 (predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'740 (predicted)',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Hs_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Hassium(Hs):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1984)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=108 , Group=8 ,Period=7 ,Block= d , CAS Number=54037-57-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'269' ,
                       "Oxidation_state = ":'[+8]' ,
                       "Atomic_radius (pm)= ":'126(predicted)',
                       "Covelent_radius(pm) = ":'134(predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'730(predicted)',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Mt_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Meitnerium(Mt):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1982)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=109 , Group=9 ,Period=7 ,Block= d , CAS Number=54038-01-6')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'278' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'128(predicted)',
                       "Covelent_radius(pm) = ":'129(predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'800(predicted)',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Ds_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Darmstadium(Ds):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1994)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=110 , Group=10 ,Period=7 ,Block= d , CAS Number=54083-77-1')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'281.16' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'132(predicted)',
                       "Covelent_radius(pm) = ":'128(predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'--',
                       "First ionization energy (kJ/mol)=":'960(predicted)',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Rg_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Roentgenium(Rg):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1994)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=111 , Group=11 ,Period=7 ,Block= d , CAS Number=54386-24-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    atomic_properties={"Atomic_weight (g / mol) = ":'281.16' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'138(predicted)',
                       "Covelent_radius(pm) = ":'121(predicted)' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'---',
                       "Melting_point(Celcius) =":'---',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'1020(predicted)',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
                       "Latent heat of Fusion (KJ/mol)=":'---',
                       "Latent heat of Vapourization (kJ/mol)=":'---',
...
def Cn_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Copernicium(Cp):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1996)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=112 , Group=12 ,Period=7 ,Block= d , CAS Number=54084-26-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'285.17' ,
                       "Oxidation_state = ":'[+2]' ,
                       "Atomic_radius (pm)= ":'---',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
...
def Nh_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Nihonium(Nh):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 2004)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=113 , Group=13 ,Period=7 ,Block= p , CAS Number=54084-70-7')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'286.18' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'170',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'1155.0',
                       "Melting_point(Celcius) =":'425.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'---',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
...
def Fl_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Flerovium(Fl):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 1998)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=114 , Group=14 ,Period=7 ,Block= p , CAS Number=54085-16-4')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'287.19' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'---',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
                       "Boiling_point(Celcius) = " :'146.0',
                       "Melting_point(Celcius) =":'68.0',
                       "Electron_affinity( kj / mol) = ":'---',
                       "First ionization energy (kJ/mol)=":'---',
                       "Refractive_index = ": '---',
                       "Speed_of_sound( m/s) = ": '---',
...
def Mc_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Moscovium(Mc):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 2003)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=115 , Group=15 ,Period=7 ,Block= p , CAS Number=54085-64-2')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'288.19' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'---',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
...
def Lv_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Livermorium(Lv):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 2000)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=116 , Group=16 ,Period=7 ,Block= p , CAS Number=54100-71-9')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'291.20' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'---',
                       "Covelent_radius(pm) = ":'175' ,
                       "Van der waals radius (pm)=":'---',
...
def Ts_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Tennessine(Ts):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 2010)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=117 , Group=17 ,Period=7 ,Block= p , CAS Number=87658-56-8')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
    ...
    content.insert(END,'PROPERTIES:-\n\n')
    atomic_properties={"Atomic_weight (g / mol) = ":'294.21' ,
                       "Oxidation_state = ":'[-]' ,
                       "Atomic_radius (pm)= ":'--',
                       "Covelent_radius(pm) = ":'---' ,
                       "Van der waals radius (pm)=":'---',
...
def Og_page():    
    ...
    info=Frame(root)
    info.grid(row=0,column=0)
    Name=Label(info,text='Oganesson(Og):')
    Name.config(font=("courier",24))
    Name.pack()
    Discovery=Label(info,text='(Discovery year : 2002 - 2005)')
    Discovery.pack()
    basic_info=Label(info,text='Atomic no=118 , Group=18 ,Period=7 ,Block= p , CAS Number=54144-19-3')
    basic_info.config(font=("courier",12))
    basic_info.pack()
    content=Text(info,height=30,width=150,font=22)
    content.pack()
